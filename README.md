...
Because of the chaotic nature of the problem, and the level of precision required, predictions were made only using the simulated data. No prediction was made based on the results of a previous prediction. In practice, compunding predictions would not be made for the same reason.
...
- Scikit-Learn for Gradient Boosting Modeling
